...
export default {
  ...
  mounted() {
    ...
    console.log(code)
    fetch(`https://secret-island-17002.herokuapp.com/github_login/${code}`)
      .then(response => {
        return response.json()
      })
      .then(data => {
          console.log(data)
        this.user_token = data.accessToken
        return fetch(`https://api.github.com/user?access_token=${data.accessToken}`)
          ...
          .then(data => {
            ...
            return fetch(`https://api.github.com/users/${data.login}/gists`)
              .then(response => {
                return response.json();
              })
              .then(data => {
